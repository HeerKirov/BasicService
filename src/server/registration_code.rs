...
pub fn register_view(scope: Scope) -> Scope {
    scope
        .route("/admin/registration-code/", web::get().to(list))
        .route("/admin/registration-code/", web::post().to(create))
        .route("/admin/registration-code/{code}/", web::get().to(retrieve))
        .route("/admin/registration-code/{code}/", web::put().to(update))
}